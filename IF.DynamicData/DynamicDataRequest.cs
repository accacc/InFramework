...
{
    public class DynamicDataRequest:BaseRequest
    {
    ...
    public static class Extensions
    {
        ...
        public static string GetSorting(this DynamicDataRequest request)
        {
            var expression = "";
        ...
        public static string GetFiltering<T>(this DynamicDataRequest request)
        {
            var finalExpression = "";
