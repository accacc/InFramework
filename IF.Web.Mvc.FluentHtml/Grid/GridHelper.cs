...
namespace IF.Web.Mvc.FluentHtml.Grid
{
    public static class GridHelper
    {
        ...
        public static ActionLinkSetBuilder GetGridRowButtons(PermissionMapDto currentAction, Action<ActionLinkSpecialFactory> configurator, IHtmlHelper htmlHelper, string gridViewId)
        {
