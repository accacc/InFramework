...
namespace IF.Core.Mvc.Extensions
{
    ...
    {
        public static IHtmlContent DropDownListMonth(this IHtmlHelper helper, string id, int? selectedValue = null, bool hasSelectAll = false)
        {
            ...
            var result = helper.DropDownList(id, items, new { @class = "select2_category form-control" });

            return result;
        }

        //public static HtmlString DropDownListIcons(this IHtmlHelper helper, string id, string selectedValue = null)
        //{
