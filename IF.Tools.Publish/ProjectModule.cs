...
namespace IF.Tools.Publish
{
    public class ProjectModule
    {
...

        {
            ...
            dllUniqueNames.Add(new ProjectModule { ModuleName = "IF.Batch", Type = ProjectType.Standart });
            dllUniqueNames.Add(new ProjectModule { ModuleName = "IF.Batch.MongoDb", Type = ProjectType.Standart });




            dllUniqueNames.OrderBy(o => o.ModuleName);
