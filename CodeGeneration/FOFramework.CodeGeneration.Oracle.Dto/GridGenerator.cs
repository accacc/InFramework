...
namespace DTOGenerator
{
    public partial class GridGenerator : Form
    {
        ...
        public StoredProcedure table { get; set; }

        FileSystemCodeFormatProvider fileSystem = new FileSystemCodeFormatProvider(@"C:\Temp");


        public GridGenerator(StoredProcedure sp, Picker form1)
        {
            //this.schema = schema;
        ...
        //    this.table = schema.StoredProcedures.Where(c => c.Name == selectedTable).First();
        ...
        private void GenerateContractClasses(string tablePascalCaseName, StoredProcedure sp)
        {
