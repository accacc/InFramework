...
namespace IF.CodeGeneration.Application.Generator.Add.Items
{
    ...
    public class AddHandlerGenerator : CSInsertGenerator, IGenerateItem
    {

        public AddHandlerGenerator(GeneratorContext context) : base(context)
        {
        ...
        public void Execute()
        {
            ...
            repositoryProperty.PropertyTypeString = GetDataInsertCommandIntarfaceName();
            ...
            constructorMethod.Parameters.Add(new CsMethodParameter() { Name = "dataCommand", Type = GetDataInsertCommandIntarfaceName() });
