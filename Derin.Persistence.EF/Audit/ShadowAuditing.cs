...
namespace Derin.Persistence.EF
{
    public class ShadowAuditing : IAuditCommand
    {
        ...
        {
            foreach (DbEntityEntry<IShadowAuditableEntity> auditable in context.ChangeTracker.Entries<IShadowAuditableEntity>())
            {
        ...
        private TempShadowClass CreateTempShadowClass(DbEntityEntry<IShadowAuditableEntity> entityEntry, AuditTypeInfo auditTypeInfo, DbContext context)
        {
        ...
        private IAuditEntity CreateAuditEntity(TempShadowClass temp, AuditTypeInfo auditTypeInfo, AuditContext context)
        {
            ...
            DbEntityEntry auditEntityEntry = context.Entry(auditEntity);           
