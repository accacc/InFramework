using Derin.Core.Mvc.Extensions;
using Derin.Core.Mvc.Model;
using IF.Web.Mvc.FluentHtml;
using Kendo.Mvc.UI;
...
namespace Derin.Web.Mvc.Kendo
{
    public class KendoForFactory<TModel> : HtmlElementForFactory<TModel> where TModel : class
    {
        ...
        public GridBuilder<T> GridAjax<T>(string actionName, string controllerName,string gridViewId, object routeValues = null) where T : BaseGridModel
        {
            ...
            return KendoHelper.GetBaseGrid<T>(this.HtmlHelper, actionName, controllerName,gridViewId,routeValues);
        }
