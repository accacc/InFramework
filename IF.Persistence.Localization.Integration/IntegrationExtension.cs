...
namespace IF.Persistence.Localization.Integration
{
    public static class IntegrationExtension
    {
        public static ILocalizationBuilder AddEntityFramework(this ILocalizationBuilder builder,IServiceCollection services,LocalizationSettings settings)
        {
        ...
        public static ILocalizationBuilder UseRequestLocalization(this ILocalizationBuilder builder, IApplicationBuilder app)
        {
